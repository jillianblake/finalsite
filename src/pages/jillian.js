...
const Jillian = (props) => (
    ...
    <h3>Principal Attorney/Owner</h3>
                    ...
                    <i><p>Jillian es abogada y propietaria de Blake Immigration Law desde 2015. Creció en San Francisco, California y obtuvo su licenciatura y maestría en estudios internacionales de la Universidad Johns Hopkins. Luego obtuvo su doctorado en jurisprudencia de la Facultad de Derecho de la Universidad de Michigan. Durante la escuela de derecho, descubrió su pasión por las leyes de inmigración y asilo mientras realizaba una pasantía en la Coalición de Derechos de los Inmigrantes del Area Capital (CAIR) y en Asylum Access-Ecuador. Jillian es miembro del Colegio de Abogados del Estado de Maryland y de la Asociación Estadounidense de Abogados de Inmigración (AILA). Actualmente también es profesora adjunta de derecho de inmigración en la Facultad de Derecho de la Universidad George Mason en Arlington, Virginia. En su tiempo libre, a Jillian le gusta ver películas, escribir, ver fútbol americano de los Cleveland Browns y béisbol de los Nacionales, y pasar tiempo con su perro, Cha Cha.</p></i>
                </div>
            </section>
        </div>
